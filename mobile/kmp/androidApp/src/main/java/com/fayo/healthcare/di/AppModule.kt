...
val appModule = module {
    ...
    single {
        ...
        val baseHost = "10.86.182.69" // Replace with your server domain/IP
        ...
        println("🔐 [AppModule] Base URLs: user=$userBaseUrl, hospital=$hospitalBaseUrl, appointment=$appointmentBaseUrl")
