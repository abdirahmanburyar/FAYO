                          ...
                          <div className="flex items-center space-x-3">
                            <div className="w-10 h-10 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-full flex items-center justify-center">
                              <span className="text-white font-medium text-sm">
                                {hospitalDoctor.doctor.specialty.substring(0, 2).toUpperCase()}
                              </span>
                            </div>
                            <div>
                              <h4 className="font-semibold text-gray-900">Dr. {hospitalDoctor.doctor.specialty}</h4>
                              <p className="text-sm text-gray-500">{hospitalDoctor.role.replace('_', ' ')}</p>
                            </div>
                          </div>
                          <div className="flex items-center space-x-2">
                            <button
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center justify-between text-sm">
                            ...
                            <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                              hospitalDoctor.isActive ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                            }`}>
