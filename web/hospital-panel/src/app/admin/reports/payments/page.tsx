...
export default function PaymentReportsPage() {
  ...
  const fetchPayments = async () => {
    try {
      ...
      // Get hospital ID and filter payments by hospital appointments
      const hospitalId = getHospitalId();
      if (!hospitalId) {
        setPaymentError('Hospital ID not found. Please log in again.');
        return;
      }
      ...
      // Fetch all payments and filter by hospital appointment IDs
      const allPaymentsRaw = await paymentApi.getAllPayments(filters);
      ...
      console.log('Hospital appointments:', appointmentIds.length);
      console.log('Filtered payments:', allPayments.length);
